...
namespace MusicStore.Controllers
{
    public class ShoppingCartControllerTest
    {
        ...
        public async Task RemoveFromCart_RemovesItemFromCart()
        {
            ...
            // Act
            var result = await controller.RemoveFromCart(recordId, CancellationToken.None);
            ...
            var cart = ShoppingCart.GetCart(dbContext, httpContext);
            Assert.False((await cart.GetCartItems()).Any(c => c.RecordId == recordId));
        }

        private static Cart[] CreateTestCartItems(string cartId, decimal itemPrice, int numberOfItem)
        {

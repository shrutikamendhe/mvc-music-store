...
namespace E2ETests
{
    ...
    {
        public const string CONNECTION_STRING_FORMAT = "Data Source=192.168.0.130;Initial Catalog={0};Persist Security Info=True;User ID=mvcappuser;Password=Newuser@123";
